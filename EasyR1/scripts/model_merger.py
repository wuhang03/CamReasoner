...
if __name__ == "__main__":
    ...
    parser.add_argument("--local_dir",type=str, default="../checkpoints/global_step_85/actor", help="The path for your saved model")
    parser.add_argument("--hf_upload_path", type=str, default="../checkpoints/global_step_85/actor", help="The path of the huggingface repo to upload")
